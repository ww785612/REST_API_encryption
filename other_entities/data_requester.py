...
def send_msg2():
  ...
  signatureRTname = privKey.sign(RT['name'].encode(), 32)

  msg2 = {
      'RT':RT,
      'signature': signatureRTname,
      'requesterPublickKey':pubKey.exportKey('PEM').decode()
  }
  ...
  msgJsonPkt = json.dumps(msgPkt)
  # owner_server_post('https://35.167.25.135:5000/dmp', jsonMsgPkt)
  post('http://192.168.71.130:5000/tasks',msgJsonPkt)
